...
public abstract class CrawlerWindow extends JFrame {
    ...
    protected Thread crawlerThread;    // Runs the crawler on a separate thread
    /**************************************************************************
	...
	/**
	 * Returns a Boolean value indicating whether or not a crawl is currently in
	 * progress
	 * 
	 ...
	 * 
	 * @param url
	 *            The URL at which to begin crawling
	 */
